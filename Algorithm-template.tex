...
%===============================环境参数===============================%
\geometry{left=1.4cm, right=0.9cm, top=1.7cm, bottom=0.5cm} % 页边距
\setlength{\columnsep}{6pt}  % 两栏之间的间距大小
\setlength\columnseprule{0.16pt} % 分割线
\setlength{\headheight}{13pt} % 修复页眉高度警告

% 优化模板间距（保持可读性）
\setlength{\parskip}{1pt}  % 段落间距 - 保持最小间距
...
% 优化代码块间距
\setlength{\topsep}{1pt}   % 环境前后间距 - 最小但非零
\setlength{\partopsep}{1pt} % 段落前环境间距

% 设置minted环境的合理间距
\BeforeBeginEnvironment{minted}{\vspace{-2pt}}
\AfterEndEnvironment{minted}{\vspace{-2pt}}

% 优化代码块间距
\setlength{\fboxsep}{2pt}  % 代码框内边距
\setlength{\abovecaptionskip}{2pt}  % 标题上方间距
\setlength{\belowcaptionskip}{2pt}  % 标题下方间距
%===============================环境参数===============================%
\hypersetup{
    colorlinks=true,
    linkcolor=black
}
\linespread{1.08}  % 优化行距避免重叠
%=============================页眉、页脚设置==============================%
\pagestyle{fancy}
...
struct FastRMQ
{
    ...
    inline T query(int l, int r) cons
    {
