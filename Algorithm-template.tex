...
% 缩小复杂度注释和代码块之间的间距
\setlength{\topsep}{0pt}   % 环境前后间距
\setlength{\partopsep}{0pt} % 段落前环境间距
...
% 进一步缩小代码块间距
\setlength{\fboxsep}{1pt}  % 代码框内边距
\setlength{\abovecaptionskip}{1pt}  % 标题上方间距
\setlength{\belowcaptionskip}{1pt}  % 标题下方间距
%===============================环境参数===============================%
\hypersetup{
    colorlinks=true,
    linkcolor=black
}
\linespread{1.04}  % 稍微减小行距
%=============================页眉、页脚设置==============================%
\pagestyle{fancy}
